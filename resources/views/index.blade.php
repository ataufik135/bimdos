            ...
            <div class="card-body p-3">
              <div class="d-flex">
                <div class="avatar avatar-xl bg-gradient-dark border-radius-md p-2">
                  <img
                    src="https://e7.pngegg.com/pngimages/44/585/png-clipart-computer-icons-businessperson-company-logo-business-company-people.png"
                    alt="slack_logo">
                </div>
              ...
              <p class="text-sm mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione commodi vitae
                nobis deleniti dolore odit excepturi provident ex placeat! Accusamus?</p>
